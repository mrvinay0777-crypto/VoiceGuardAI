...
st.markdown(
    '<meta name="google-site-verification" content="fUqDh8aJhfs1etvOPPTwgyA0rWnB7WOmX1dUO1Gfhf4" />',
    unsafe_allow_html=True
)

# Google Analytics Tag (Jo tera pehle se tha)
st.markdown("""
...
st.title("VoiceGuard AI: Deepfake Audio Detector")
st.markdown(
